...
public class AboutUs extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       //extView myTextView = (TextView) v.findViewById(R.id.AbtUs_tv);
        Typeface typeface=Typeface.createFromAsset(getActivity().getAssets(), "fonts/bradhitc.ttf");
       //yTextView.setTypeface(typeface);
        return v;
    }
